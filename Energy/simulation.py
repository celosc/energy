...
s1.addConnection(3, h3, h3.ports[0], bandwidth=1000000000) # Link de 100 Mbps

s1.addConnection(4, s3, 1, bandwidth=10000000) # Link de 1 Gbps

s1.addConnection(5, s2, 4, bandwidth=1000000000) # Link de 1 Gbps

s3.addConnection(1, s1, 4, bandwidth=10000000) # Link de 1 Gbps

s3.addConnection(2, s2, 2, bandwidth=10000000) # Link de 1 Gbps

s2.addConnection(1, h4, h4.ports[0], bandwidth=1000000000) # Link de 100 Mbps

s2.addConnection(2, s3, 2, bandwidth=10000000) # Link de 1 Gbps
...
p = topo.findpaths(h3,h4,1000000000)
